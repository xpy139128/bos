...
public class WayBill {
	...
	@Field(index=FieldIndex.analyzed,store=true,type=FieldType.String,analyzer="ik",searchAnalyzer="ik")
	...
	public String toString() {
		return "WayBill [id=" + id + ", wayBillNum=" + wayBillNum + ", sendName=" + sendName + ", sendMobile="
				+ sendMobile + ", sendCompany=" + sendCompany + ", sendAddress=" + sendAddress + ", recName=" + recName
				+ ", recMobile=" + recMobile + ", recCompany=" + recCompany + ", recAddress=" + recAddress
				+ ", sendProNum=" + sendProNum + ", goodsType=" + goodsType + ", payTypeNum=" + payTypeNum + ", weight="
				+ weight + ", remark=" + remark + ", num=" + num + ", arriveCity=" + arriveCity + ", feeitemnum="
				+ feeitemnum + ", actlweit=" + actlweit + ", vol=" + vol + ", floadreqr=" + floadreqr + ", wayBillType="
				+ wayBillType + ", signStatus=" + signStatus + ", delTag=" + delTag + "]";
	}
